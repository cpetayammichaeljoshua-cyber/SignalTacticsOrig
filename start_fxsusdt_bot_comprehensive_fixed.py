...
async def main():
    ...
    logger.info(f"⏱️ Timeframe: 1 MINUTE SCALPING (+ 5m confirmation)")
    logger.info(f"🚀 Fast Execution Mode: Enabled for rapid entry/exit")
    logger.info(f"🎯 Strategy: Ichimoku Sniper - 1m Optimized")
