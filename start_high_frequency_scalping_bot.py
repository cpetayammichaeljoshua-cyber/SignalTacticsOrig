...
async def main():
    ...
    logger.info("="*80)
    logger.info("⚙️  SIGNAL CONSENSUS (PRODUCTION-GRADE):")
    logger.info(f"   Minimum strategies agree: {orchestrator.min_strategies_agree}/6")
    logger.info(f"   Minimum consensus confidence: {orchestrator.min_consensus_confidence}%")
    logger.info(f"   Minimum signal strength: {orchestrator.min_signal_strength}%")
    logger.info("="*80)
